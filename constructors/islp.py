...
class islp:
    def __init__(self, dialect: str):
        ...
        self.load_path = f'ilsp/{dialect}-speech-corpus'
    ...
    def load_islp_subset(self, split: str):
...
if __name__ == '__main__':
    extractor = islp(dialect='messenian')
    _ = extractor.load_islp_subset('train')

    extractor = islp(dialect='cretan')
    _ = extractor.load_islp_subset('train')