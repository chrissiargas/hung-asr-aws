...
import librosa
import shutil
from preprocessing.full import check_full_dataocean_657
import re
...
class dataocean_asr_657:
    ...
    def load_dataocean_subset(self, split: str, remove: bool = False):
        ...
        incomplete = check_full_dataocean_657(manifest_dir, source_file)
                ...
                for batch_folder in os.listdir(self.load_dir):
                    ...
                    if 'CHANNEL' in batch_folder:
                        ...
                        for subject_clip_folder in os.listdir(clips_path):
                            ...
                            if (batch_folder.upper(), subject_clip_folder.upper()) not in incomplete:
                                print(f"Skipping {channel} {subject_id} as it is already complete.")
                                continue
